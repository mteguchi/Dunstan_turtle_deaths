...
LOOIC.DIC.Heat.df <- data.frame(model = c("M1", "M2", "M3", "M4", "M5", "M6",
...
Models were compared using DIC and LOOIC. Both model selection criterion indicated that Model 10 (St_K1_K2_P) was best. The Rhat statistic indicated convergence was reached for all parameters (max(Rhat) < 1.1). 
...
ggsave(filename = "figures/heat_facet.png", 
...
knitr::include_graphics("figures/heat_facet.png")
```
...
#write.csv(total.deaths.heat, file = "data/total_deaths_heat.csv")
...
LOOIC.DIC.Cliff.df <- data.frame(model = c("M1", "M2", "M3", "M4", "M5", "M6",
                                       "M7", "M8", "M9", "M10", "M11", "M12"),
...
ggsave(filename = "figures/cliff_facet.png", 
...
knitr::include_graphics("figures/cliff_facet.png")
```
...
#write.csv(total.deaths.cliff, file = "data/total_deaths_cliff.csv")
```
