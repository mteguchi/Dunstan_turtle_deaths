...
model.names <- c("S_K_norm", "St_K_norm", "S_K1_K2_norm",
                 "St_K1_K2_norm", "S1_S2_K_norm", "S1_S2_K1_K2_norm",
                 "S_K_P_norm", "St_K_P_norm", "S_K1_K2_P_norm",
                 "St_K1_K2_P_norm", "S1_S2_K_P_norm", "S1_S2_K1_K2_P_norm",
                 "S_K_Pois", "St_K_Pois", "S_K1_K2_Pois",
                 "St_K1_K2_Pois", "S1_S2_K_Pois", "S1_S2_K1_K2_Pois",
                 "S_K_P_Pois", "St_K_P_Pois", "S_K1_K2_P_Pois",
                 "St_K1_K2_P_Pois", "S1_S2_K_P_Pois", "S1_S2_K1_K2_P_Pois",
                 "S_K_sigmaYt_norm", "St_K_sigmaYt_norm", "S_K1_K2_sigmaYt_norm",
                 "St_K1_K2_sigmaYt_norm", "S1_S2_K_sigmaYt_norm", "S1_S2_K1_K2_sigmaYt_norm",
                 "S_K_P_sigmaYt_norm", "St_K_P_sigmaYt_norm", "S_K1_K2_P_sigmaYt_norm",
                 "St_K1_K2_P_sigmaYt_norm", "S1_S2_K_P_sigmaYt_norm", "S1_S2_K1_K2_P_sigmaYt_norm")
...
Model 22 (St_K1_K2_P_Pois) seems to be the best according to LOOIC and DIC values. Convergence was reached for all parameters as well (max.Rhat < 1.1). Pareto k statistics look okay also...

```{r}

best.model.heat.looic <- readRDS(paste0("RData/Richards_Heat_", 
                                        model.names[[22]], "_LOOIC.rds"))
...
```{r}
best.model.heat <- readRDS(paste0("RData/Richards_Heat_", model.names[[22]], ".rds"))
...
These don't look so bad but there were some high Rhat values... find which ones... 2020-07-02
...
X_Heat_St_K1_K2_P <- compute.summary.stats_St_K1_K2_P(best.model.heat$samples, 
                                                      seasons, 
                                                      max.days$total.days)
...
Pareto_k values show that M18 is a better model than M14 (fewer bad and very bad data points.) So, I'll go with M18 for now.  2020-07-02.
```{r}
best.model.cliff.ID <- 14
...
Although some are very bad, the majority are okay. Take a look at some trace plots:
...
These are not quite acceptable... 

```{r}
mcmc_trace(best.model.cliff$samples, c("S1", "S2"))
```

These look horrible as well... 
...
So, I'll use Model 10 for computing the total deaths due to the heat related reasons.
