...
Model 22 (St_K1_K2_P_Pois) seems to be the best according to LOOIC and DIC values but the convergence is an issue. I can increase the MCMC sample size later. For now, I'll use the first one with convergence  (Model 16) for this time. Pareto k statistics look okay also...  
