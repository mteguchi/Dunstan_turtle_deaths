...
Then send it to jags.

```{r run_jags, include=FALSE, echo=FALSE, cache=TRUE}
jags.data.Heat.P <- list(y = (obs.y.1[,,1]),
                         ...
                         # N.mean.log = log(data.2$PI),
                         # N.SE.log = log(data.2$SE))
...
# I added sumXa in the code - calculate the season-sums within JAGS
# This may be less efficient but good to get everything done in one.
jags.params <- c("sigma.y", "S", "K1", "K2", "P", "max", 
                  "sumXa", "y", "X", "sigma.max", "deviance", "loglik")
...
if (!file.exists("RData/Heat_Richards_St_K1_K2_P_norm_sumX.rds")){
jm <- jags(data = jags.data.Heat.P,
           inits = NULL,
           parameters.to.save= jags.params,
           model.file = 'models/model_Richards_St_K1_K2_P_norm.txt',
           n.chains = MCMC.params$n.chains,
           n.burnin = MCMC.params$n.burnin,
           n.thin = MCMC.params$n.thin,
           n.iter = MCMC.params$n.samples,
           DIC = T, parallel=T)
  saveRDS(jm, "RData/Heat_Richards_St_K1_K2_P_norm_sumX.rds")
}
...
best.model.heat <- readRDS("RData/Heat_Richards_St_K1_K2_P_norm_sumX.rds")
